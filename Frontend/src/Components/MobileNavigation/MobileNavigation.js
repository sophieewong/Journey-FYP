...
class MobileNavigation {
    ...
    setupEventListeners() {
        const openMobileMenuButton = document.getElementById('component-mobile-navigation-open-menu-button');
        const closeMobileMenuButton = document.getElementById('component-mobile-navigation-close-menu-button');
